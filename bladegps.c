 ...
 */
size_t
fifo_read (int16_t * buffer, size_t samples, sim_t * s)
{
  size_t length;
 ...
 */
bool
is_finished_generation (sim_t * s)
{
  return s->finished;
}
